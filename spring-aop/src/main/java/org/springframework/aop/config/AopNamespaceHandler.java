...
public class AopNamespaceHandler extends NamespaceHandlerSupport {
	...
	public void init() {
		...
		registerBeanDefinitionParser("config", new ConfigBeanDefinitionParser());								// 声明式 AOP 支持， 注入 AspectJAwareAdvisorAutoProxyCreator
		registerBeanDefinitionParser("aspectj-autoproxy", new AspectJAutoProxyBeanDefinitionParser());		// 主解式 AOP 支持,  注入 AnnotationAwareAspectJAutoProxyCreator
